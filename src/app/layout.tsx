  ...
  return (
    <html lang="en" className="font-sans">
      <body className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
        <header className="border-b border-zinc-200/60 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-950/60 backdrop-blur">
          <div className="container flex h-16 items-center justify-between">
            <Link href="/" className="font-semibold tracking-tight hover:opacity-90">Bradford Arnold</Link>
            <nav className="flex items-center gap-6">
              ...
              <a href="mailto:bradfordm.arnold@gmail.com"
        ...
        <footer className="mt-16 border-t border-zinc-200/60 dark:border-zinc-800/80">
          <div className="container py-8 text-sm text-zinc-600 dark:text-zinc-400 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <p>© {new Date().getFullYear()} Bradford Arnold</p>
            <p>Contact: <a className="underline underline-offset-4" href="mailto:bradfordm.arnold@gmail.com">bradfordm.arnold@gmail.com</a></p>
          </div>
        </footer>
      </body>
    </html>
